...
class CGI:
        ...
        def __init__ (self,
                ...
                if logfilename is None:
                        ...
                        try:
                                ...
                                self.log ('Could not open log file %s' % logfilename)
                                self.logfd = None
                self.fields = {}
        ...
        def get_parms (self,
                ...
                if not ((default_fields is None) and (default_types is None)):
                        self.fields = mgi_cgi.FieldStorage ( default_fields, default_types)
                else:
                        fs = cgi.FieldStorage()
        ...
        def go (self,
                handler = errorlib.handle_error # function to call if an exception occurs
                ):
        ...
        def main (self):
                ...
                #       program" of the CGI script.  Define this in a subclass for each CGI script.
                # Returns: nothing
                # Assumes: nothing
                # Effects: nothing
                # Throws: nothing
